...
# =============================================================================
set bit  {D:/FPGA/project_9/out/aurora_udp_bridge.bit}
...
puts "调试核数量 = [llength $ilas]  （期望 2 = 确实是 project_9 的设计）"
