## ============================================================
## mig_verify_pins.xdc �� DDR4 PACKAGE_PINs from official KU_IO.xdc
## (IOSTANDARD provided by MIG IP xdc; sys_clk/reset/leds below)
## ============================================================
...
## ---- MIG system clock: onboard 100MHz diff (AK17/AK16) ----
## override MIG default DIFF_SSTL12: proven standard on this ball is DIFF_HSTL_I_12
...
set_property -dict {PACKAGE_PIN AC34 IOSTANDARD LVCMOS18} [get_ports sys_rst_btn]

## ---- status LEDs ----
set_property -dict {PACKAGE_PIN T22 IOSTANDARD LVCMOS18} [get_ports led_calib]
set_property -dict {PACKAGE_PIN T23 IOSTANDARD LVCMOS18} [get_ports led_pass]

## async reset button into MIG (core has internal synchronizers)
